...
public class StartNewCorrelatedScopeTask extends  ScopeAdminTask{
    public StartNewCorrelatedScopeTask(ScopedAdmin scopedAdmin) {
        super(scopedAdmin);
    }
    ...
    public ResponseDefinition execute(Admin a, Request request, PathParams pathParams) {
        ...
        CorrelationState scope= admin.startNewCorrelatedScope(correlationState.getCorrelationPath());
