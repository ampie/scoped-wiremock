package com.sbg.bdd.cucumber.common;
...
public class CopiedJSONFormatter implements Reporter, Formatter {
    ...
    protected enum Phase {step, match, embedding, output, result};
    ...
    public CopiedJSONFormatter(Appendable out) {
